...
urlpatterns = patterns('',
    ...
    url(r'^home/$', ChiChi.views.home),
    url(r'^blog/$', ChiChi.views.blog),
    url(r'^adventure/$', ChiChi.views.adventure),
    url(r'^about/$', ChiChi.views.about),
    url(r'^result/$', ChiChi.views.submit_comment),

    url(r'^a/(\w+)/$', ChiChi.handlers.ajax_handler),
)
